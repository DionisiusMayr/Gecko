...
# RUN curl -o /usr/local/spark-3.5.0-bin-hadoop3/jars/hadoop-aws-3.4.0.jar  https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-aws/3.4.0/hadoop-aws-3.4.0.jar
# RUN curl -o /usr/local/spark-3.5.0-bin-hadoop3/jars/aws-java-sdk-bundle-1.12.99.jar https://repo1.maven.org/maven2/com/amazonaws/aws-java-sdk-bundle/1.12.99/aws-java-sdk-bundle-1.12.99.jar
